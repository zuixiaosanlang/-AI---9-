...
def paddle2yolo():
    JSON = "G:/work/for_fun/zuixiaosanlang_20220123/table_dataset/train/annos.txt"  # paddle 提供的标签
    src_dir = "G:/work/for_fun/fei_jiang/table/Dataset/inpainting_kpt/train_A/"     # paddle 提供的训练数据集
    dst_images_dir = "dataset/table-seg/images/"     # yolov5 训练数据集
    dst_labels_dir = "dataset/table-seg/labels/"    # yolov5 标签
